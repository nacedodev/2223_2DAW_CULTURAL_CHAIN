    ...
    ?>
                <div>
                    ...
                    <a href="index.php?controller=reflexiones&action=listarReflexiones&nivel_id=<?php echo $nivel['id'];?>&nombrepais=<?php echo $nivel['nombrepais'];?>"><img style='margin-left:15px;' src='../img/iconos/libro.png'></a>

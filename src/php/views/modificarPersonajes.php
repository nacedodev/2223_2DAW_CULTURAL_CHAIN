    <?php if(isset($controlador->mensaje)): ?>
    ...
    <figure class="figure-container" data-image="">
            <img src="data:image/png;base64,<?php $imagen = new mPersonaje(HOST,USER,PASSWORD,DATABASE, CHARSET); echo $imagen->obtenerImagenPorId($_GET['id']);?>" class="personaje">

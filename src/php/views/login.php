...
<body>
<form action="index.php?controller=login&action=verificarCredenciales" method="POST">
  ...
  <div class="form-group">
    ...
    <button type="button" title="Reveal Password" aria-pressed="false" style="height:25%;top: 59%;">

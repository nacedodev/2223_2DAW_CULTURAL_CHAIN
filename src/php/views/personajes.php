<div id="panelCentro">
    ...
    ?>
                <div>
                    ...
                    <a href="index.php?action=modificarCentro&controller=centros&id=<?php echo $personaje['id']; ?>&nombre=<?php echo $personaje['nombre']; ?>&localidad=<?php echo $centro['localidad']; ?>"><img style="margin-left:15px;" src="../img/iconos/edit.png"></a>
